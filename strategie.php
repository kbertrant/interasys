...
<div id="banner-area">
					...
					<div class="post-content">
						...
						<div class="row">
							...
							<div class="feature-box col-sm-6 wow fadeInDown" data-wow-delay=".5s">
								...
								<div class="feature-content">
									<h3>DONNEES PRELIMINAIRES ET RESULTATS</h3>
					...
					<div class="sidebar sidebar-right">
						...
						<div class="widget widget-categories">
							...
							<ul class="category-list clearfix">
				              <li><a href="#">Web design</a><span class="posts-count"> (2)</span></li>
				              <li><a href="#">Technologie</a><span class="posts-count"> (1)</span></li>
				              <li><a href="#">Applications</a><span class="posts-count"> (10)</span></li>
	...
	<section class="call-to-action">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h3>Demandez un dévi et nous vous répondons sous 24h </h3>
					<a href="#" class="pull-right btn btn-primary white">Ecrivez-nous</a>
				</div>
			</div>
		</div>
	</section>
